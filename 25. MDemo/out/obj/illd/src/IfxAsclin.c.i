# 1 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\25E35F~1.MDE\\illd\\src\\IfxAsclin.c"
# 1 "C:\\Users\\Auto\\Desktop\\rtos-workspace\\myproject\\25. MDemo\\out//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\25E35F~1.MDE\\illd\\src\\IfxAsclin.c"
# 48 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\25E35F~1.MDE\\illd\\src\\IfxAsclin.c"
...
# 49 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\25E35F~1.MDE\\illd\\src\\IfxAsclin.c" 2
...
{
    return (volatile Ifx_SRC_SRCR *)(&(*(Ifx_SRC*)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].ERR);
}


volatile Ifx_SRC_SRCR *IfxAsclin_getSrcPointerRx(Ifx_ASCLIN *asclin)
{
    return (volatile Ifx_SRC_SRCR *)(&(*(Ifx_SRC*)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].RX);
}


volatile Ifx_SRC_SRCR *IfxAsclin_getSrcPointerTx(Ifx_ASCLIN *asclin)
{
    return (volatile Ifx_SRC_SRCR *)(&(*(Ifx_SRC*)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].TX);
}
...
boolean IfxAsclin_setBitTiming(Ifx_ASCLIN *asclin, float32 baudrate, IfxAsclin_OversamplingFactor oversampling, IfxAsclin_SamplePointPosition samplepoint, IfxAsclin_SamplesPerBit medianFilter)
{
    ...
    oversampling = (IfxAsclin_OversamplingFactor)Ifx__maxu((oversampling + 1), 4);
    samplepoint = (IfxAsclin_SamplePointPosition)Ifx__maxu(samplepoint, 1);
    fOvs = baudrate * oversampling;
    float32 relError = fOvs;
    float32 limit = 0.001 * fOvs;

    boolean terminated = (0u);
    float32 newRelError;
...
# 404 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\25E35F~1.MDE\\illd\\src\\IfxAsclin.c" 2
