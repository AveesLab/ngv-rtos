# 1 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO\\illd\\src\\IfxPort.c"
# 1 "C:\\Users\\Auto\\Desktop\\rtos-workspace\\myproject\\26. MLoss\\out//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO\\illd\\src\\IfxPort.c"
# 46 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO\\illd\\src\\IfxPort.c"
...
# 57 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO/illd\\Libraries\\Infra\\Sfr\\TC27D\\_Reg\\IfxPort_regdef.h"
# 1 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO/illd\\Libraries\\Infra\\Sfr\\TC27D\\_Reg\\Ifx_TypesReg.h" 1
# 58 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO/illd\\Libraries\\Infra\\Sfr\\TC27D\\_Reg\\IfxPort_regdef.h" 2
...
# 47 "C:\\Users\\Auto\\Desktop\\RTOS-W~1\\MYPROJ~1\\269076~1.MLO\\illd\\src\\IfxPort.c" 2
...
void IfxPort_resetESR(Ifx_P *port, uint8 pinIndex)
{
    ...
    Ifx__ldmst(&port->ESR.U, 1U << pinIndex, 0);
...
void IfxPort_setESR(Ifx_P *port, uint8 pinIndex)
{
    ...
    IfxScuWdt_clearCpuEndinit(passwd);
    Ifx__ldmst(&port->ESR.U, 1U << pinIndex, 1U << pinIndex);
    IfxScuWdt_setCpuEndinit(passwd);
}
...
void IfxPort_setGroupModeInput(Ifx_P *port, uint8 pinIndex, uint16 mask, IfxPort_InputMode mode)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if (iocrMask[i] != 0)
        {
            Ifx__ldmst(&((&(port->IOCR0.U))[i]), iocrMask[i], iocrVal[i]);
        }
    }
}
...
void IfxPort_setGroupModeOutput(Ifx_P *port, uint8 pinIndex, uint16 mask, IfxPort_OutputMode mode, IfxPort_OutputIdx index)
{
    ...
    if(index == IfxPort_OutputIdx_general){};
...
void IfxPort_setGroupPadDriver(Ifx_P *port, uint8 pinIndex, uint16 mask, IfxPort_PadDriver padDriver)
{
    ...
    IfxScuWdt_clearCpuEndinit(passwd);
    {
        ...
        for (i = 0; i < 2; i++)
        {
            if (pdrMask[i] != 0)
            {
                Ifx__ldmst(&((&(port->PDR0.U))[i]), pdrMask[i], pdrVal[i]);
            }
        }
    }
    IfxScuWdt_setCpuEndinit(passwd);
...
void IfxPort_setPinMode(Ifx_P *port, uint8 pinIndex, IfxPort_Mode mode)
{
    ...
    Ifx__ldmst(&iocr[iocrIndex].U, (0xFFUL << shift), (mode << shift));
}
...
void IfxPort_setPinPadDriver(Ifx_P *port, uint8 pinIndex, IfxPort_PadDriver padDriver)
{
    ...
    IfxScuWdt_clearCpuEndinit(passwd);
    {
        ...
        Ifx__ldmst(&(pdr[pdrIndex]), (0xFUL << shift), (padDriver << shift));
    }
    IfxScuWdt_setCpuEndinit(passwd);
}
